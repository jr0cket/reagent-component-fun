(defproject component-fun "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "component-fun.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main component-fun.server
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "component-fun.core/on-figwheel-reload"}

                :compiler {:main component-fun.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/component_fun.js"
               ...
               {:id "test"
                ...
                :compiler {:output-to "resources/public/js/compiled/testable.js"
                           :main component-fun.test-runner
                           :optimizations :none}}
